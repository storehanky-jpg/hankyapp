...
import {
  ...
  Activity, ScrollText, Monitor, Smartphone, LogOut, Home, ChevronRight,
} from 'lucide-react';
                    ...
                    <tr key={u.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex justify-end gap-1">
                          ...
                          <button onClick={() => { setResetUser(u); setNewPassword(''); }} title="Mot de passe" className="p-2 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors">
                            <KeyRound size={16} />
                          </button>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setResetUser(null)}>
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <button type="button" onClick={() => { setNewPassword(genRandomPassword()); setShowPassword(true); }}
                className="text-sm text-amber-600 hover:text-amber-800 font-medium">
                Générer un mot de passe aléatoire
              </button>
